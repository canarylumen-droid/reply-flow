...
const Booking = () => {
    ...
    return (
        <section id="book" className='py-24 px-4 bg-white dark:bg-[#0A0A0B] border-t border-gray-100 dark:border-white/5'>
            <div className='max-w-7xl mx-auto'>
                <div className='text-center mb-16'>
                    <motion.div
                        initial={{ opacity: 0, scale: 0.9 }}
                        whileInView={{ opacity: 1, scale: 1 }}
                        className='inline-block px-4 py-1.5 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-black uppercase tracking-widest mb-6 font-syne'
                    >
                        Strategic Deployment
                    </motion.div>
                    <h2 className='text-4xl md:text-6xl font-black mb-6 dark:text-white tracking-tighter font-syne uppercase'>Review Your Strategy</h2>
