            ...
            <div className='max-w-7xl mx-auto relative z-10'>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch'>
                    ...
                    <div className='p-10 rounded-[40px] bg-gray-50 dark:bg-zinc-900/50 border border-gray-100 dark:border-white/5 flex flex-col group hover:border-purple-500/30 transition-all duration-500'>
                        ...
                        <a
                            href="mailto:team@replyflow.pro?subject=Growth%20Partnership%20Application&body=Hi%20ReplyFlow%20Team%2C%0A%0AI%27m%20submitting%20my%20application%20for%20a%20Growth%20Partnership.%20We%20are%20ready%20to%20deploy%20AI%20infrastructure%20to%20scale%20our%20revenue.%0A%0AHere%20are%20my%20details%3A%0A%0AEst.%20Monthly%20Revenue%3A%20%0ANiche%20%2F%20Industry%3A%20%0AWebsite%20%2F%20Socials%3A%20%0A%0ALooking%20forward%20to%20scaling%20together."
                            className='w-full py-4 rounded-2xl border-2 border-gray-200 dark:border-white/10 text-gray-900 dark:text-white font-black text-sm uppercase tracking-widest hover:bg-gray-100 dark:hover:bg-white/5 transition-colors text-center block'
                        >
